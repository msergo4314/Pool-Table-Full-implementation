...
class Database:
    ...
    def open_cursor(self):
        self.open_connection() # make sure there is a connection first
...
class Game:
    ...
    def __init__(self, gameID=None, gameName=None, player1Name=None, player2Name=None):
        ...
        Game.database.createDB() # create db tables if not already created
    ...
    def shoot(self, playerName, table, xvel, yvel) -> tuple[Table]:
