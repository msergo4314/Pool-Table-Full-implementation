...
class Game:
    ...
    def get_number_of_tables_for_shot(self) -> Table:
        self.open_cursor()
        num_shots = Game.current_cursor.execute("SELECT COUNT(TABLEID) FROM TableShot WHERE TableShot.SHOTID = ?;", (self.most_recent_shot_ID,)).fetchone()[0]
        self.close_cursor()
        return num_shots
